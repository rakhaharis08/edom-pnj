...
module.exports = {
  async kajur(req, res) {
    ...
    FROM
        ...
        JOIN table_jurusan ON table_prodi.prodi_jurusan = table_jurusan.jurusan_id
        JOIN table_kajur ON table_jurusan.jurusan_id = table_kajur.kajur_jurusan
        JOIN table_dosen ON table_answer.answer_dosen = table_dosen.dosen_id
      WHERE
            table_answer.answer_semester ='2' AND
            table_kajur.kajur_user = '5'
    GROUP BY
        table_dosen.dosen_name`);
